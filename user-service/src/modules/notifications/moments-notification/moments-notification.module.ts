...
import {
  MomentsNotifaction,
  MomentsNotifactionSchema,
} from './moments.notification.schema';

@Module({
  imports: [
    MongooseModule.forFeature([
      { name: MomentsNotifaction.name, schema: MomentsNotifactionSchema },
    ]),
  ],
  providers: [MomentsNotificationService],
  controllers: [MomentsNotificationController],
  exports: [MomentsNotificationService],
})
