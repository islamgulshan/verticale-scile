...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get top 3 candidate matches for a given job' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Array of matched candidates with similarity scores',
        type: match_dto_1.MatchDto,
        isArray: true,
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Fetch matching results from cache' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MatchController.prototype, "getMatchResults", null);
