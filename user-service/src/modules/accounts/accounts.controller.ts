...
export class AccountsController {
  ...
  @MessagePattern('create-update-accounts')
  create(@Payload() dto: Partial<Accounts>): Promise<Accounts> {
    return this.accountsServiceService.create(dto);
  }
  @MessagePattern('create-update-accounts-verification')
  createPersnalInfo(@Payload() dto: Partial<Accounts>): Promise<Accounts> {
    return this.accountsServiceService.createPersnalInfo(dto);
  }

  @MessagePattern('user-accounts')
  getByUser(@Payload() user_id: Partial<Accounts>): Promise<Accounts> {
    return this.accountsServiceService.getByUser(user_id);
  }
  @MessagePattern('decativation-accounts')
  deActive(@Payload() dto: Partial<Accounts>): Promise<Accounts> {
