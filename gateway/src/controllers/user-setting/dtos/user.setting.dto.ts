...
export class UserBenefitDto {
  ...
  @ApiProperty({
    description: 'Description for user benefit',
    example: 'User gets access to exclusive content',
  })
  @IsString()
  @IsOptional()
  description: string;
...
export class ReferralDto {
  @ApiProperty({
    ...
    enum: ReferralActionEnum,
    example: ReferralActionEnum.GENERATE_CODE,
  })
...
export class MonetizationDto {
  ...
  @ApiProperty({
    ...
    example: 'Exclusive content for premium users',
  })
  @IsString()
...
export class CreateUserSettingDto {
  ...
  @ApiProperty({
    description: 'User role',
    enum: UserRole,
    example: UserRole.CONTENT_CREATOR,
  })
  @IsEnum(UserRole)
  role: UserRole;
